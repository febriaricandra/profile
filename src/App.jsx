...
function Card({ children, style, hover = true, onClick }) {
  ...
  return (
    <div
      data-brutal-interactive={onClick ? "true" : undefined}
      onClick={onClick}
            ...
            {skills.map((s, i) => (
              <Card key={s.cat} style={{ padding: smallMobile ? 12 : mobile ? 18 : 20 }}>
                ...
                <div style={{ display: "flex", flexWrap: "wrap", gap: 2 }}>
                  {s.items.map((sk) => (
                    <SkillTag key={sk} label={sk} color={colorMap[i]} />
                  ))}
                </div>
              </Card>
            ))}
              ...
              >
                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", flexWrap: "wrap", gap: 8 }}>
                  ...
                  <div
                    style={{
                      padding: "6px 12px",
                      background: experiences[activeExp].color,
                ...
                <div style={{ fontFamily: "'Space Grotesk', sans-serif", fontSize: 15, lineHeight: 1.8, color: COLORS.black, marginTop: 20, opacity: 0.85 }}>
